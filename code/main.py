...
from powerup import Bulletup, Speedup, Healthup, Liveup, Shieldup, Missileup, Missile
from ebullet import Roundbullet, Dart, X
...
loseimg = pygame.image.load(path.join(img_dir,"gameoverimg.png")).convert_alpha()
...
#******button********
startimg = pygame.image.load(path.join(img_dir,"start.png")).convert_alpha()
backimg = pygame.image.load(path.join(img_dir,"back.png")).convert_alpha()
exitimg = pygame.image.load(path.join(img_dir,"exit.png")).convert_alpha()
back = pygame.image.load(path.join(img_dir,"back.png")).convert_alpha()
replayimg = pygame.image.load(path.join(img_dir,"replay.png")).convert_alpha()
infoimg = pygame.image.load(path.join(img_dir,"infoimg.png")).convert_alpha()
pause = pygame.image.load(path.join(img_dir,"jeda.png")).convert_alpha()
cont = pygame.image.load(path.join(img_dir,"lanjut.png")).convert_alpha()
#*********Function**********
...
menu = Button(pause, width / 2 - 370, height/2 - 400, 700, 500, None)
lose = Button(loseimg, width / 2 - 400, height/2 - 300, 800, 600, None)
#*********Class*********
...
def main():
    ...
    while True:
        ...
        exit = Button(exitimg,width-300,height/2+100,200,150, quitgame)
        game = Button(startimg,100,height/2+100,200,150, gameloop)
        exit.draw(screen)
        game.draw(screen)
...
def info():
    ...
    while True:
        ...
        exit.draw(screen)
        game.draw(screen)
        Button(back,width/2-100,height/2+100,200,150,main)
...
def pausegame():
    ...
    while paused[0]:
        ...
        screen.blit(infobackground, (0, 0))
        cont_button = Button(cont, width / 2 - 100, height / 2 - 50, 220, 120, unpause)
        exit = Button(exitimg, width / 2 - 100, height / 2 + 30, 200, 150, main)
        menu.draw(screen)
        exit.draw(screen)
...
def gameover():
    ...
    while True:
        ...
        exit = Button(exitimg,width-700,height/2+100, 200, 150,quitgame)
        replay = Button(replayimg,width / 2 - 300, height / 2 + 50, 300, 200,gameloop)
