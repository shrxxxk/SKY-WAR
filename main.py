...
from settings import snd_dir, img_dir, screen, width, height
...
def intro():
    ...
    while True:
        ...
        label("Sky War",width/2-100,200,60,red)
        label("Tips: kill enemies to get powerups",width/2-200,400,30,orange)
        Button("Exit",width-250,height/2+150,100,50,red,brightred,quitgame)
        Button("Start",150,height/2+150,100,50,green,brightgreen,gameloop)
        Button("Info",680,height/2+150,100,50,blue,brightblue,info)
...
def info():
    ...
    while True:
        ...
        screen.blit(on_music, (width / 2 - 90, 490))
        label("Sound On", width / 2 - 40, 490, 20, brightblue)
        screen.blit(off_music, (width / 2 - 90, 530))
        label("Sound Off", width / 2 - 40, 530, 20, brightblue)

        Button("Sound Off",150, 50, width-100, 50, red, brightred, sound_off)
        Button("Sound On",300, 200, 100, 50, green, brightgreen, sound_on)
        ...
        Button("Menu",680,height/2+200,100,50,blue,brightblue,intro)
...
def pausegame():
    ...
    while paused[0]:
        ...
        screen.blit(infobackground, (0, 0))
        label("Paused", width / 2 - 160, height / 2 - 200, 100, brightred)
        Button("Continue", width - 250, height / 2 + 100, 200, 50, green, brightgreen, unpause)
        Button("Exit", 150, height / 2 + 100, 100, 50, red, brightred, intro)
...
def gameloop():
    ...
    while True:
        ...
        try:
            if enemy1.drawph:
                enemy1.enemy_health(enemy1.ph, enemy1.fullph, 100, 50)
        except:
            pass
        # draw enemy2 ph
        try:
            if enemy2.drawph:
                enemy2.enemy_health(enemy2.ph, enemy2.fullph, 100, 50)
        except:
            pass
        # draw enemy3 ph
        try:
            if enemy3.drawph:
                enemy3.enemy_health(enemy3.ph, enemy3.fullph, 100, 50)
        except:
            pass
        # draw boss1 ph
        try:
